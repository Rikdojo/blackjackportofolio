...
class Environment:
    def __init__(self,  player=[], dealer=[], deck=[], dealer_hidden = [],point_count= 0):
        ...
        self.true_count = max(-5,min(round(self.point_count/(len(self.deck)/52)),5))
    ...
    def deck_reset(self):
        ...
        single_deck = [(card, category) for category in card_categories for card in cards_list] * 6
    ...
    def dealer_sum_cards(self, cards):
        current_value = []
        ace_idx = []
        idx = 0
        ace_check = 'No Ace'
